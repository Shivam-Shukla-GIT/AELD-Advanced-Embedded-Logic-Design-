...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net fir_compiler_0_m_axis_data_tdata [get_bd_pins fir_compiler_acp/m_axis_data_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net fir_compiler_0_m_axis_data_tlast [get_bd_pins axi_dma_acp/s_axis_s2mm_tlast] [get_bd_pins fir_compiler_acp/m_axis_data_tlast]
  connect_bd_net -net fir_compiler_0_m_axis_data_tvalid [get_bd_pins axi_dma_acp/s_axis_s2mm_tvalid] [get_bd_pins fir_compiler_acp/m_axis_data_tvalid]
  connect_bd_net -net fir_compiler_hp_m_axis_data_tdata [get_bd_pins fir_compiler_hp/m_axis_data_tdata] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_acp/axi_resetn] [get_bd_pins axi_dma_hp/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins fir_compiler_acp/aresetn] [get_bd_pins fir_compiler_hp/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins axi_dma_acp/s_axis_s2mm_tdata] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins axi_dma_hp/s_axis_s2mm_tdata] [get_bd_pins xlslice_1/Dout]
