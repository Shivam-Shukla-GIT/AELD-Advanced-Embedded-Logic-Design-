...
proc create_root_design { parentCell } {
  ...
  # Create instance: matmul_MM_SP_0, and set properties
  set matmul_MM_SP_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matmul_MM_SP:1.1 matmul_MM_SP_0 ]

  # Create instance: matrixmul_2_0, and set properties
  set matrixmul_2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrixmul_2:1.1 matrixmul_2_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrixmul_2_0/in_A]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins matrixmul_3_0/in_A]
  ...
  connect_bd_intf_net -intf_net matmul_MM_SP_0_m_axi_gmem [get_bd_intf_pins axi_smc/S04_AXI] [get_bd_intf_pins matmul_MM_SP_0/m_axi_gmem]
  connect_bd_intf_net -intf_net matrixmul_2_0_out_C [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matrixmul_2_0/out_C]
  connect_bd_intf_net -intf_net matrixmul_3_0_out_C [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins matrixmul_3_0/out_C]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces matmul_MM_SP_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matmul_MM_SP_0/s_axi_AXILiteS/Reg] SEG_matmul_MM_SP_0_Reg
  ...
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces matmul_MM_SP_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs matmul_MM_SP_0/Data_m_axi_gmem/SEG_processing_system7_0_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces matmul_MM_SP_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs matmul_MM_SP_0/Data_m_axi_gmem/SEG_processing_system7_0_ACP_M_AXI_GP0]
