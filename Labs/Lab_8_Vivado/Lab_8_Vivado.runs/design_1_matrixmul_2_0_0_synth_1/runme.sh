...
HD_PWD='D:/Sem_6/AELD/Labs/Lab_8_Vivado/Lab_8_Vivado.runs/design_1_matrixmul_2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_2_0_0.tcl
