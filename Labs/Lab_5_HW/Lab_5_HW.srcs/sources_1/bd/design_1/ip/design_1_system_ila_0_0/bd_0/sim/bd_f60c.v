...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe44(net_slot_1_axi_awid),
        .probe45(net_slot_1_axi_awlen),
        .probe46(net_slot_1_axi_awlock),
        .probe47(net_slot_1_axi_awprot),
        .probe48(net_slot_1_axi_awqos),
        .probe49(net_slot_1_axi_awsize),
        .probe5(net_slot_0_axi_arlock),
        .probe50(net_slot_1_axi_b_cnt),
        .probe51(net_slot_1_axi_bid),
        .probe52(net_slot_1_axi_bresp),
        .probe53(net_slot_1_axi_r_cnt),
        .probe54(net_slot_1_axi_rdata),
        .probe55(net_slot_1_axi_rid),
        .probe56(net_slot_1_axi_rresp),
        .probe57(net_slot_1_axi_wdata),
        .probe58(net_slot_1_axi_wid),
        ...
        .probe65(net_slot_2_axi_ar_cnt),
        .probe66(net_slot_2_axi_araddr),
        .probe67(net_slot_2_axi_arburst),
        .probe68(net_slot_2_axi_arcache),
        .probe69(net_slot_2_axi_arlen),
        .probe7(net_slot_0_axi_arqos),
        .probe70(net_slot_2_axi_arlock),
        .probe71(net_slot_2_axi_arprot),
        .probe72(net_slot_2_axi_arqos),
        .probe73(net_slot_2_axi_arsize),
        .probe74(net_slot_2_axi_aw_cnt),
        .probe75(net_slot_2_axi_awaddr),
        .probe76(net_slot_2_axi_awburst),
        .probe77(net_slot_2_axi_awcache),
        .probe78(net_slot_2_axi_awlen),
        .probe79(net_slot_2_axi_awlock),
        .probe8(net_slot_0_axi_arsize),
        .probe80(net_slot_2_axi_awprot),
        .probe81(net_slot_2_axi_awqos),
        .probe82(net_slot_2_axi_awsize),
        .probe83(net_slot_2_axi_b_cnt),
        .probe84(net_slot_2_axi_bresp),
        .probe85(net_slot_2_axi_r_cnt),
        .probe86(net_slot_2_axi_rdata),
        .probe87(net_slot_2_axi_rresp),
        .probe88(net_slot_2_axi_wdata),
        .probe89(net_slot_2_axi_wstrb),
        .probe9(net_slot_0_axi_aw_cnt),
        .probe90(net_slot_2_axi_aw_ctrl),
        .probe91(net_slot_2_axi_w_ctrl),
        .probe92(net_slot_2_axi_b_ctrl),
        .probe93(net_slot_2_axi_ar_ctrl),
        .probe94(net_slot_2_axi_r_ctrl));
