...
HD_PWD='D:/Sem_6/AELD/Labs/Lab_7_Vivado/Lab_7_Vivado.runs/design_1_matrixmul_1_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_1_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_1_0_2.tcl
