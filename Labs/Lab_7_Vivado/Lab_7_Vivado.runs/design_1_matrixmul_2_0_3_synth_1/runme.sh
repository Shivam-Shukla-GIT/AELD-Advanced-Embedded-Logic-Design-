...
HD_PWD='D:/Sem_6/AELD/Labs/Lab_7_Vivado/Lab_7_Vivado.runs/design_1_matrixmul_2_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_2_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_2_0_3.tcl
