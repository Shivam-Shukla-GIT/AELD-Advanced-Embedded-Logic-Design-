...
`define AUTOTB_DUT      matrixmul_1
`define AUTOTB_DUT_INST AESL_inst_matrixmul_1
`define AUTOTB_TOP      apatb_matrixmul_1_top
`define AUTOTB_LAT_RESULT_FILE "matrixmul_1.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matrixmul_1.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matrixmul_1_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define AUTOTB_II 6149
`define AUTOTB_LATENCY 6148
...
`define AUTOTB_TVIN_in_A_V_data  "./c.matrixmul_1.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V  "./c.matrixmul_1.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data  "./c.matrixmul_1.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V  "./c.matrixmul_1.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVIN_in_A_V_data_out_wrapc  "./rtl.matrixmul_1.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V_out_wrapc  "./rtl.matrixmul_1.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data_out_wrapc  "./rtl.matrixmul_1.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V_out_wrapc  "./rtl.matrixmul_1.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data  "./c.matrixmul_1.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V  "./c.matrixmul_1.autotvout_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data_out_wrapc  "./impl_rtl.matrixmul_1.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V_out_wrapc  "./impl_rtl.matrixmul_1.autotvout_out_C_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 6148;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matrixmul_1.autotvout_out_C_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmul_1.autotvout_out_C_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmul_1.autotvout_out_C_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmul_1.autotvout_out_C_V_data.dat\"!");
    else begin
        $display("Comparing rtl.matrixmul_1.autotvout_out_C_V_data.dat with impl_rtl.matrixmul_1.autotvout_out_C_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matrixmul_1.autotvout_out_C_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmul_1.autotvout_out_C_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmul_1.autotvout_out_C_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmul_1.autotvout_out_C_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.matrixmul_1.autotvout_out_C_V_last_V.dat with impl_rtl.matrixmul_1.autotvout_out_C_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
