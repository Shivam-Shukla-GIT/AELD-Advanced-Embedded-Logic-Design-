...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmul_1.autotvin.dat"
	set constFileTvOut       "matrixmul_1.autotvout.dat"
	set constFileHdlTvIn     "matrixmul_1.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmul_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
