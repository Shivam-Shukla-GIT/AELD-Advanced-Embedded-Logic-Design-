...
`define AUTOTB_TVIN_in_A_V_data  "../tv/cdatafile/c.matrixmul_1.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V  "../tv/cdatafile/c.matrixmul_1.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data  "../tv/cdatafile/c.matrixmul_1.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V  "../tv/cdatafile/c.matrixmul_1.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVIN_in_A_V_data_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data  "../tv/cdatafile/c.matrixmul_1.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V  "../tv/cdatafile/c.matrixmul_1.autotvout_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.matrixmul_1.autotvout_out_C_V_last_V.dat"
module `AUTOTB_TOP;
