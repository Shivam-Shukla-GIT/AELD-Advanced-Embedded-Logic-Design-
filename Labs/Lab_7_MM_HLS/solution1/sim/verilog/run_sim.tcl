...
if {[file isfile matrixmul_1.autotvin.dat]} {
	file delete -force matrixmul_1.autotvin.dat
}

if {[file isfile matrixmul_1.autotvout.dat]} {
	file delete -force matrixmul_1.autotvout.dat
}
