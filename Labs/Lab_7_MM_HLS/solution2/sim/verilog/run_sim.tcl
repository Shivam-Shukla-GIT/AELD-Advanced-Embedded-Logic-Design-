...
if {[file isfile matrixmul_2.autotvin.dat]} {
	file delete -force matrixmul_2.autotvin.dat
}

if {[file isfile matrixmul_2.autotvout.dat]} {
	file delete -force matrixmul_2.autotvout.dat
}
