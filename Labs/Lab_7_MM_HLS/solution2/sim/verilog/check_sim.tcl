...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixmul_2.autotvin_in_A_V_data.dat"
         "c.matrixmul_2.autotvin_in_A_V_last_V.dat"
         "c.matrixmul_2.autotvin_out_C_V_data.dat"
         "c.matrixmul_2.autotvin_out_C_V_last_V.dat"
         "c.matrixmul_2.autotvout_out_C_V_data.dat"
         "c.matrixmul_2.autotvout_out_C_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixmul_2.autotvout_out_C_V_data.dat"
         "rtl.matrixmul_2.autotvout_out_C_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
