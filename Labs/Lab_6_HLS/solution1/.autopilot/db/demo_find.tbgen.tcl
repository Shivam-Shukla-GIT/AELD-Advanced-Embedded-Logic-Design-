...
set portList { 
	...
	{ out_vec_TREADY sc_in sc_logic 1 outacc 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_vec_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "out_vec_V_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	out_vec_V_data_V { axis {  { out_vec_TDATA out_data 1 32 }  { out_vec_TREADY out_acc 0 1 } } }
	out_vec_V_last_V { axis {  { out_vec_TVALID out_vld 1 1 }  { out_vec_TLAST out_data 1 1 } } }
}
