...
`define AUTOTB_DUT      demo_find
`define AUTOTB_DUT_INST AESL_inst_demo_find
`define AUTOTB_TOP      apatb_demo_find_top
`define AUTOTB_LAT_RESULT_FILE "demo_find.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "demo_find.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_demo_find_top
...
`define AUTOTB_TVIN_val_r  "./c.demo_find.autotvin_val_r.dat"
`define AUTOTB_TVIN_in_vec_V_data_V  "./c.demo_find.autotvin_in_vec_V_data_V.dat"
`define AUTOTB_TVIN_in_vec_V_last_V  "./c.demo_find.autotvin_in_vec_V_last_V.dat"
`define AUTOTB_TVIN_out_vec_V_data_V  "./c.demo_find.autotvin_out_vec_V_data_V.dat"
`define AUTOTB_TVIN_out_vec_V_last_V  "./c.demo_find.autotvin_out_vec_V_last_V.dat"
`define AUTOTB_TVIN_val_r_out_wrapc  "./rtl.demo_find.autotvin_val_r.dat"
`define AUTOTB_TVIN_in_vec_V_data_V_out_wrapc  "./rtl.demo_find.autotvin_in_vec_V_data_V.dat"
`define AUTOTB_TVIN_in_vec_V_last_V_out_wrapc  "./rtl.demo_find.autotvin_in_vec_V_last_V.dat"
`define AUTOTB_TVIN_out_vec_V_data_V_out_wrapc  "./rtl.demo_find.autotvin_out_vec_V_data_V.dat"
`define AUTOTB_TVIN_out_vec_V_last_V_out_wrapc  "./rtl.demo_find.autotvin_out_vec_V_last_V.dat"
`define AUTOTB_TVOUT_out_vec_V_data_V  "./c.demo_find.autotvout_out_vec_V_data_V.dat"
`define AUTOTB_TVOUT_out_vec_V_last_V  "./c.demo_find.autotvout_out_vec_V_last_V.dat"
`define AUTOTB_TVOUT_out_vec_V_data_V_out_wrapc  "./impl_rtl.demo_find.autotvout_out_vec_V_data_V.dat"
`define AUTOTB_TVOUT_out_vec_V_last_V_out_wrapc  "./impl_rtl.demo_find.autotvout_out_vec_V_last_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.demo_find.autotvout_out_vec_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.demo_find.autotvout_out_vec_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.demo_find.autotvout_out_vec_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.demo_find.autotvout_out_vec_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.demo_find.autotvout_out_vec_V_data_V.dat with impl_rtl.demo_find.autotvout_out_vec_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.demo_find.autotvout_out_vec_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.demo_find.autotvout_out_vec_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.demo_find.autotvout_out_vec_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.demo_find.autotvout_out_vec_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.demo_find.autotvout_out_vec_V_last_V.dat with impl_rtl.demo_find.autotvout_out_vec_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
