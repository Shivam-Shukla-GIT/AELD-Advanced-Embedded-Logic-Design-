...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "demo_find.autotvin.dat"
	set constFileTvOut       "demo_find.autotvout.dat"
	set constFileHdlTvIn     "demo_find.autohdltvin.dat"
	set constFileHdlTvOut    "demo_find.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
