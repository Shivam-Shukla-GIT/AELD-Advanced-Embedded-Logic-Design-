...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.demo_find.autotvin_val_r.dat"
         "c.demo_find.autotvin_in_vec_V_data_V.dat"
         "c.demo_find.autotvin_in_vec_V_last_V.dat"
         "c.demo_find.autotvin_out_vec_V_data_V.dat"
         "c.demo_find.autotvin_out_vec_V_last_V.dat"
         "c.demo_find.autotvout_out_vec_V_data_V.dat"
         "c.demo_find.autotvout_out_vec_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.demo_find.autotvout_out_vec_V_data_V.dat"
         "rtl.demo_find.autotvout_out_vec_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
