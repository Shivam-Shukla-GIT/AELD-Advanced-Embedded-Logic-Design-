...
if {[file isfile demo_find.autotvin.dat]} {
	file delete -force demo_find.autotvin.dat
}

if {[file isfile demo_find.autotvout.dat]} {
	file delete -force demo_find.autotvout.dat
}
