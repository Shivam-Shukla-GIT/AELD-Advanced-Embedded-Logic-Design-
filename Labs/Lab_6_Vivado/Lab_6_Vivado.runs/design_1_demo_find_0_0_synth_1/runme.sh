...
HD_PWD='D:/Sem_6/AELD/Labs/Lab_6_Vivado/Lab_6_Vivado.runs/design_1_demo_find_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_demo_find_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_demo_find_0_0.tcl
