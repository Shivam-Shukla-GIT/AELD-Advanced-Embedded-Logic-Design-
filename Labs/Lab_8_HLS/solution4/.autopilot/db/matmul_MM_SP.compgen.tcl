...
set ID 19
set hasByteEnable 0
set MemName matmul_MM_SP_Inarbkb
...
set ID 20
set hasByteEnable 0
set MemName matmul_MM_SP_Outacud
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 64
...
set ID 21
set hasByteEnable 0
set MemName matmul_MM_SP_In_A_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 8
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 22 \
			corename matmul_MM_SP_AXILiteS_axilite \
			name matmul_MM_SP_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_MM_SP_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_MM_SP_gmem_m_axi
}
