...
`define AUTOTB_DUT      matmul_MM_SP
`define AUTOTB_DUT_INST AESL_inst_matmul_MM_SP
`define AUTOTB_TOP      apatb_matmul_MM_SP_top
`define AUTOTB_LAT_RESULT_FILE "matmul_MM_SP.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matmul_MM_SP.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matmul_MM_SP_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_Matrix_In 1
`define AESL_DEPTH_Matrix_C_HW 1
`define AUTOTB_TVIN_gmem  "./c.matmul_MM_SP.autotvin_gmem.dat"
`define AUTOTB_TVIN_Matrix_In  "./c.matmul_MM_SP.autotvin_Matrix_In.dat"
`define AUTOTB_TVIN_Matrix_C_HW  "./c.matmul_MM_SP.autotvin_Matrix_C_HW.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.matmul_MM_SP.autotvin_gmem.dat"
`define AUTOTB_TVIN_Matrix_In_out_wrapc  "./rtl.matmul_MM_SP.autotvin_Matrix_In.dat"
`define AUTOTB_TVIN_Matrix_C_HW_out_wrapc  "./rtl.matmul_MM_SP.autotvin_Matrix_C_HW.dat"
`define AUTOTB_TVOUT_gmem  "./c.matmul_MM_SP.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.matmul_MM_SP.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 451;
parameter LENGTH_gmem = 192;
parameter LENGTH_Matrix_In = 1;
parameter LENGTH_Matrix_C_HW = 1;
...
wire [32 - 1:0] Matrix_In;
wire [32 - 1:0] Matrix_C_HW;
AESL_axi_master_gmem AESL_AXI_MASTER_gmem(
    ...
    .TRAN_gmem_Matrix_In (Matrix_In),
    .TRAN_gmem_Matrix_C_HW (Matrix_C_HW),
...
AESL_axi_slave_AXILiteS AESL_AXI_SLAVE_AXILiteS(
    ...
    .TRAN_Matrix_In (Matrix_In),
    .TRAN_Matrix_C_HW (Matrix_C_HW),
...
reg end_Matrix_In;
reg [31:0] size_Matrix_In;
reg [31:0] size_Matrix_In_backup;
reg end_Matrix_C_HW;
reg [31:0] size_Matrix_C_HW;
reg [31:0] size_Matrix_C_HW_backup;
