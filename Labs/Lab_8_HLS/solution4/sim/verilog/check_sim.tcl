...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matmul_MM_SP.autotvin_gmem.dat"
         "c.matmul_MM_SP.autotvin_Matrix_In.dat"
         "c.matmul_MM_SP.autotvin_Matrix_C_HW.dat"
         "c.matmul_MM_SP.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matmul_MM_SP.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
