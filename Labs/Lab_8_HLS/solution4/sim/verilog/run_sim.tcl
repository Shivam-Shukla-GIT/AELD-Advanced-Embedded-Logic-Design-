...
if {[file isfile matmul_MM_SP.autotvin.dat]} {
	file delete -force matmul_MM_SP.autotvin.dat
}

if {[file isfile matmul_MM_SP.autotvout.dat]} {
	file delete -force matmul_MM_SP.autotvout.dat
}
