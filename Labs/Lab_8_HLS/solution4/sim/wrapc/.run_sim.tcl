...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matmul_MM_SP.autotvin.dat"
	set constFileTvOut       "matmul_MM_SP.autotvout.dat"
	set constFileHdlTvIn     "matmul_MM_SP.autohdltvin.dat"
	set constFileHdlTvOut    "matmul_MM_SP.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
