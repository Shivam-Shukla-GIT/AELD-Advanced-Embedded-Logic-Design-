...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmul_2.autotvin.dat"
	set constFileTvOut       "matrixmul_2.autotvout.dat"
	set constFileHdlTvIn     "matrixmul_2.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmul_2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
