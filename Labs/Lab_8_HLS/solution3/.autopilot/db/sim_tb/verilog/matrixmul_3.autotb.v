...
`define AUTOTB_II 310
`define AUTOTB_LATENCY 309
...
`define AUTOTB_TVIN_in_A_V_data  "./c.matrixmul_3.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V  "./c.matrixmul_3.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data  "./c.matrixmul_3.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V  "./c.matrixmul_3.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVIN_in_A_V_data_out_wrapc  "./rtl.matrixmul_3.autotvin_in_A_V_data.dat"
`define AUTOTB_TVIN_in_A_V_last_V_out_wrapc  "./rtl.matrixmul_3.autotvin_in_A_V_last_V.dat"
`define AUTOTB_TVIN_out_C_V_data_out_wrapc  "./rtl.matrixmul_3.autotvin_out_C_V_data.dat"
`define AUTOTB_TVIN_out_C_V_last_V_out_wrapc  "./rtl.matrixmul_3.autotvin_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data  "./c.matrixmul_3.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V  "./c.matrixmul_3.autotvout_out_C_V_last_V.dat"
`define AUTOTB_TVOUT_out_C_V_data_out_wrapc  "./impl_rtl.matrixmul_3.autotvout_out_C_V_data.dat"
`define AUTOTB_TVOUT_out_C_V_last_V_out_wrapc  "./impl_rtl.matrixmul_3.autotvout_out_C_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 309;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matrixmul_3.autotvout_out_C_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmul_3.autotvout_out_C_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmul_3.autotvout_out_C_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmul_3.autotvout_out_C_V_data.dat\"!");
    else begin
        $display("Comparing rtl.matrixmul_3.autotvout_out_C_V_data.dat with impl_rtl.matrixmul_3.autotvout_out_C_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matrixmul_3.autotvout_out_C_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmul_3.autotvout_out_C_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmul_3.autotvout_out_C_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmul_3.autotvout_out_C_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.matrixmul_3.autotvout_out_C_V_last_V.dat with impl_rtl.matrixmul_3.autotvout_out_C_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
