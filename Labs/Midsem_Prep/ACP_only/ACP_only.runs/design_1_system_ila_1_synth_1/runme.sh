...
HD_PWD='D:/Sem_6/AELD/Labs/Midsem_Prep/ACP_only/ACP_only.runs/design_1_system_ila_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_1.tcl
