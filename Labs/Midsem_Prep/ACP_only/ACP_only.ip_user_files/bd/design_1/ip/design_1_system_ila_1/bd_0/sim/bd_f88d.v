...
//--------------------------------------------------------------------------------
//Command: generate_target bd_f88d.bd
//Design : bd_f88d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_f88d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_f88d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_system_ila_1.hwdef" *) 
module bd_f88d
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
    ...
    probe1,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_2_FCLK_CLK0, DATA_WIDTH 64, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 16, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI3, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_2_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXIS, CLK_DOMAIN design_1_processing_system7_0_2_FCLK_CLK0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]SLOT_2_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_2_FCLK_CLK0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  input [31:0]probe0;
  input [39:0]probe1;
  ...
  assign probe1_1 = probe1[39:0];
  assign resetn_1 = resetn;
  bd_f88d_g_inst_0 g_inst
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_f88d_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe57(net_slot_1_axi_rid),
        .probe58(net_slot_1_axi_rresp),
        .probe59(net_slot_1_axi_wdata),
        .probe6(net_slot_0_axi_arlen),
        .probe60(net_slot_1_axi_wid),
        .probe61(net_slot_1_axi_wstrb),
        .probe62(net_slot_1_axi_aw_ctrl),
        .probe63(net_slot_1_axi_w_ctrl),
        .probe64(net_slot_1_axi_b_ctrl),
        .probe65(net_slot_1_axi_ar_ctrl),
        .probe66(net_slot_1_axi_r_ctrl),
        .probe67(net_slot_2_axis_tdata),
        .probe68(net_slot_2_axis_tkeep),
        .probe69(net_slot_2_axis_tvalid),
        .probe7(net_slot_0_axi_arlock),
        .probe70(net_slot_2_axis_tready),
        .probe71(net_slot_2_axis_tlast),
