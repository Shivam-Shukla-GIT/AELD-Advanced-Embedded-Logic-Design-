...
HD_PWD='D:/Sem_6/AELD/Labs/Midsem_Prep/ACP_HP_both/ACP_HP_both.runs/design_1_axi_dma_acp_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dma_acp_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dma_acp_0.tcl
