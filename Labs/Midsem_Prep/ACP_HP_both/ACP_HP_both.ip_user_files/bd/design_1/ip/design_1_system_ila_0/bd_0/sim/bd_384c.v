...
(* CORE_GENERATION_INFO = "bd_384c,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_384c,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_system_ila_0.hwdef" *) 
module bd_384c
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_2_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 64, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 16, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI3, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_2_AXI_araddr;
  ...
  wire [3:0]net_slot_2_axi_awlen;
  wire [1:0]net_slot_2_axi_awlock;
  ...
  assign probe0_1 = probe0[39:0];
  assign probe1_1 = probe1[31:0];
  assign probe2_1 = probe2[39:0];
  ...
  bd_384c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe100(net_slot_3_axis_tkeep),
        .probe101(net_slot_3_axis_tvalid),
        .probe102(net_slot_3_axis_tready),
        .probe103(net_slot_3_axis_tlast),
        .probe104(net_slot_4_axis_tdata),
        .probe105(net_slot_4_axis_tkeep),
        .probe106(net_slot_4_axis_tvalid),
        .probe107(net_slot_4_axis_tready),
        .probe108(net_slot_4_axis_tlast),
        .probe11(net_slot_0_axi_arqos),
        ...
        .probe6(net_slot_0_axi_arburst),
        .probe60(net_slot_1_axi_rresp),
        .probe61(net_slot_1_axi_wdata),
        .probe62(net_slot_1_axi_wid),
        .probe63(net_slot_1_axi_wstrb),
        ...
        .probe69(net_slot_2_axi_ar_cnt),
        .probe7(net_slot_0_axi_arcache),
        .probe70(net_slot_2_axi_araddr),
        .probe71(net_slot_2_axi_arburst),
        .probe72(net_slot_2_axi_arcache),
        .probe73(net_slot_2_axi_arlen),
        .probe74(net_slot_2_axi_arlock),
        .probe75(net_slot_2_axi_arprot),
        .probe76(net_slot_2_axi_arqos),
        .probe77(net_slot_2_axi_arsize),
        .probe78(net_slot_2_axi_aw_cnt),
        .probe79(net_slot_2_axi_awaddr),
        .probe8(net_slot_0_axi_arlen),
        .probe80(net_slot_2_axi_awburst),
        .probe81(net_slot_2_axi_awcache),
        .probe82(net_slot_2_axi_awlen),
        .probe83(net_slot_2_axi_awlock),
        .probe84(net_slot_2_axi_awprot),
        .probe85(net_slot_2_axi_awqos),
        .probe86(net_slot_2_axi_awsize),
        .probe87(net_slot_2_axi_b_cnt),
        .probe88(net_slot_2_axi_bresp),
        .probe89(net_slot_2_axi_r_cnt),
        .probe9(net_slot_0_axi_arlock),
        .probe90(net_slot_2_axi_rdata),
        .probe91(net_slot_2_axi_rresp),
        .probe92(net_slot_2_axi_wdata),
        .probe93(net_slot_2_axi_wstrb),
        .probe94(net_slot_2_axi_aw_ctrl),
        .probe95(net_slot_2_axi_w_ctrl),
        .probe96(net_slot_2_axi_b_ctrl),
        .probe97(net_slot_2_axi_ar_ctrl),
        .probe98(net_slot_2_axi_r_ctrl),
        .probe99(net_slot_3_axis_tdata),
